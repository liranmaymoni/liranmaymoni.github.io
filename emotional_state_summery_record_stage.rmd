...
Mean and standard deviation of emotions across subjects and 10-s interbals (in the record stage)
...
mydata <- read.csv(file="C:/Users/Liran/Google Drive/Study/PhD/Face_Reader/The_Experiment/Emotional_state_summery/emotional_progression_record.csv", header=TRUE, sep=",")
...
market_prices_1 = unfactor(data.frame(S1 %>% filter(V3=="subjects", V5==1))[c(1:15),57])
market_prices_2 = unfactor(data.frame(S1 %>% filter(V3=="subjects", V5==1))[c(16:30),57])
...
market_prices_1 = unfactor(data.frame(S2 %>% filter(V3=="subjects", V5==1))[c(1:15),57])
market_prices_2 = unfactor(data.frame(S2 %>% filter(V3=="subjects", V5==1))[c(16:30),57])
max1 = which.is.max(market_prices_1)
max2 = which.is.max(market_prices_2)
...
market_prices_1 = unfactor(data.frame(S3 %>% filter(V3=="subjects", V5==1))[c(1:15),57])
market_prices_2 = unfactor(data.frame(S3 %>% filter(V3=="subjects", V5==1))[c(16:30),57])
max1 = which.is.max(market_prices_1)
max2 = which.is.max(market_prices_2)
...
market_prices_1 = unfactor(data.frame(S4 %>% filter(V3=="subjects", V5==1))[c(1:15),57])
market_prices_2 = unfactor(data.frame(S4 %>% filter(V3=="subjects", V5==1))[c(16:30),57])
max1 = which.is.max(market_prices_1)
max2 = which.is.max(market_prices_2)
...
market_prices_1 = unfactor(data.frame(S5 %>% filter(V3=="subjects", V5==1))[c(1:15),57])
market_prices_2 = unfactor(data.frame(S5 %>% filter(V3=="subjects", V5==1))[c(16:30),57])
max1 = which.is.max(market_prices_1)
max2 = which.is.max(market_prices_2)
...
market_prices_1 = unfactor(data.frame(S6 %>% filter(V3=="subjects", V5==1))[c(1:15),57])
market_prices_2 = unfactor(data.frame(S6 %>% filter(V3=="subjects", V5==1))[c(16:30),57])
max1 = which.is.max(market_prices_1)
max2 = which.is.max(market_prices_2)
