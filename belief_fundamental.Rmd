---
title: "Beliefs as a function of fundamental value"
...
$B_{i,t}^{t+k} = C_{i} + \gamma Fundamental_{t+k}$
...
library(jtools)
library(huxtable)
mydata <- read.csv(file="C:/Users/Liran/Google Drive/Study/PhD/Face_Reader/The_Experiment/belief_fundamental/S1_S6_transpose.csv", header=TRUE, sep=",")

market1 = subset(mydata, period<=15)
market2 = subset(mydata, period>15)
#Fix effect market 1
Fixed_effects1 = plm(belief ~ fundamental, data=market1, index = c("id","t_k") , model="within")
#Fix effect market 2
Fixed_effects2 = plm(belief ~ fundamental, data=market2, index = c("id","t_k") , model="within")
...
export_summs(Fixed_effects1, Fixed_effects2, digits = 4,
            ...
            coefs =  c("Fundamental" = "fundamental"),
