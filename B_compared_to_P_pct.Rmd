---
title: "Upcoming period beliefs as a function of subjects' average emotions - percentage difference"
output:
  html_document:
    number_sections: yes
    toc: yes
...
$Y_{i,t} = \frac{Belief_{i,t,k=0}-Price_{t-1}}{Price_{t-1}}$  (only 1 period ahead).
...
#Fix effect market 1
Fixed_effects1 = plm(B_P_pct ~ neutral + happy + sad + angry + surprised + scared + disgusted, data=market1, index = c("id","t_k") , model="within")
#Fix effect market 2
Fixed_effects2 = plm(B_P_pct ~ neutral + happy + sad + angry + surprised + scared + disgusted, data=market2, index = c("id","t_k") , model="within")
