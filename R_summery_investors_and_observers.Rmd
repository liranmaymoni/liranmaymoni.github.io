...
### HL distributions
```{r, echo= FALSE, message=FALSE}
HL = unfactor(data.frame(mydata %>% filter(V3=="subjects", V4==1))[,2465])
...
### CRT distributions
```{r, echo= FALSE, message=FALSE}
CRT = unfactor(data.frame(mydata %>% filter(V3=="subjects", V4==30))[,2503])
...
```{r, echo= FALSE, message=FALSE}
gender = unfactor(data.frame(mydata %>% filter(V3=="subjects", V4==30))[,2511])
...
```{r, echo= FALSE, message=FALSE}
market_prices_1 = unfactor(data.frame(mydata %>% filter(V3=="subjects", V5==1))[c(1:15),57])
market_prices_2 = unfactor(data.frame(mydata %>% filter(V3=="subjects", V5==1))[c(16:30),57])
...
for(i in 1:15){
  market1_beliefs[i,] = colMeans(unfactor(data.frame(mydata %>% filter(V3=="contracts",V4==i))[1:participates,7:21]))
}
...
for(i in 1:15){
  market2_beliefs[i,] = colMeans(unfactor(data.frame(mydata %>% filter(V3=="contracts",V4==15+i))[1:participates,7:21]))
}
...
for(i in 1:15){
  market1_beliefs_investors[i,] = colMeans(unfactor(data.frame(mydata %>% filter(V3=="contracts",V4==i, V5 %in% (1:investors), V27 != 0))[1:investors,7:21]))
}
...
for(i in 1:15){
  market2_beliefs_investors[i,] = colMeans(unfactor(data.frame(mydata %>% filter(V3=="contracts",V4== 15 + i, V5 %in% (1:investors), V27 != 0))[1:investors,7:21]))
}
...
for(i in 1:15){
  market1_beliefs_observers[i,] = colMeans(unfactor(data.frame(mydata %>% filter(V3=="contracts",V4==i, V5 %in% (investors+1:participates), V27 != 0))[1:(participates -investors),7:21]))
}
...
for(i in 1:15){
  market2_beliefs_observers[i,] = colMeans(unfactor(data.frame(mydata %>% filter(V3=="contracts",V4==15 + i, V5 %in% (investors+1:participates), V27 != 0))[1:(participates -investors),7:21]))
}
